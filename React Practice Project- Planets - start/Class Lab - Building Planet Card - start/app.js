...
const Planet=(props)=>{
  ...
  props.whole.map(
  p=>
  <Planet url={p.url} name={p.name} desc={p.desc} diameter={p.diameter} moons={p.moons} />
  ...
  ReactDOM.render(
  <ContainerForAll whole={planets}/>,document.getElementById("root")
  )